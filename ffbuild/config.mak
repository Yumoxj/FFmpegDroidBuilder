...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/mnt/e/share/ffmpeg/ffmpeg-5.1.4/android/armv8-a --enable-neon --enable-shared --enable-small --disable-vulkan --disable-gpl --disable-postproc --disable-jni --disable-mediacodec --disable-decoder=h264_mediacodec --disable-static --disable-doc --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-avdevice --disable-symver --enable-cross-compile --cross-prefix=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm- --target-os=android --arch=arm64 --cpu=armv8-a --cc=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang --cxx=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++ --sysroot=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/sysroot --extra-cflags='-mno-stackrealign -Os -fpic -mfpu=neon -march=armv8-a' --extra-ldflags=
prefix=/mnt/e/share/ffmpeg/ffmpeg-5.1.4/android/armv8-a
...
INTRINSICS=neon
EXTERN_PREFIX=
CC=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang
CXX=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang++
AS=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang
OBJCC=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang
LD=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang
DEPCC=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar
NM_CMD=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-nm -g
METALCC=xcrun -sdk macosx metal
METALLIB=xcrun -sdk macosx metallib
RANLIB=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib -D
STRIP=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip
STRIPTYPE=direct
NVCC=clang
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/sysroot -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -mno-stackrealign -Os -fpic -mfpu=neon -march=armv8-a -march=armv8-a -std=c11 -fPIE -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Oz -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -mno-stackrealign -Os -fpic -mfpu=neon -march=armv8-a -march=armv8-a -fPIC -g -Qunused-arguments
...
LD_PATH=-L
DLLTOOL=
WINDRES=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-windres
DOXYGEN=doxygen
LDFLAGS=   --sysroot=/root/ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/sysroot -march=armv8-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil -Qunused-arguments
LDEXEFLAGS= -fPIE -pie
LDSOFLAGS=
